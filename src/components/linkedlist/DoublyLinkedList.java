...
public class DoublyLinkedList<T> extends LinkedListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        this.postRear.previous = this.preFront;
     ...
     *
     */
    private class DoublyLinkedList1Iterator implements Iterator<T> {
         ...
         */
        DoublyLinkedList1Iterator() {
            this.cursor = DoublyLinkedList.this.preFront;
        }

        @Override
        public boolean hasNext() {
            return this.cursor.next != DoublyLinkedList.this.postRear;
        }
    ...
    public void add(T entry) {
        ...
        this.postRear.previous = newNode;
    ...
    public void addToFront(T entry) {
        ...
        newFront.previous = this.preFront;
    ...
    public T removeRear() {
        Node rear = this.rear;
        Node newRear = rear.previous;
        newRear.next = this.postRear;
        this.postRear.previous = newRear;
        this.rear = newRear;
        this.length--;
    ...
    public void retreat() {
        ...
        Node newPreFocus = this.preFocus.previous;
        this.preFocus = newPreFocus;
        this.position--;
    }
    ...
    public void moveToRear() {
        ...
        this.preFocus = this.rear.previous;
    ...
    public Iterator<T> iterator() {
        return new DoublyLinkedList1Iterator();
    }
    ...
    public void transferFrom(LinkedList<T> source) {
        DoublyLinkedList<T> localSource = (DoublyLinkedList<T>) source;
    ...
    @Override
    public DoublyLinkedList<T> newInstance() {
        try {
